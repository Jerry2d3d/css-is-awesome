...
function writeThemeScss(cia, options = {}) {
  ...
  lines.push(`// ${name} theme — generated by \`cia migrate tailwind\``);
  ...
  lines.push(
    `// The UNMAPPED block at the bottom shows Tailwind values that didn't`,
  );
  ...
  if (cia.unmapped.length > 0) {
    lines.push(``);
    lines.push(`/* UNMAPPED — Tailwind values with no direct cia analog. Review + add`);
