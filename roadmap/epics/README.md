...
| [v1.1](./v1-1/README.md) | **Recipes momentum** — 14 more recipes across two batches (7 original + 7 Boiler-backed), playground, install wizard, @cia/a11y-recipes, @cia/react codegen POC, density knob, MCP zero-install | v1-1/ | 72 | **In progress** — EPIC-08 (batch-2 recipes) **Complete**: all 7 shipped 2026-09-10 (datepicker, data-table, confirm-dialog, admin-dashboard-layout, auth-flow, otp-input, multi-step-wizard), 21 recipes now in the book. EPIC-09 Playground moved in from v1-0 the same day (0/7). Remaining epics unstarted. (The npm version 1.1.0, published 2026-09-01, is NOT this backlog; see version-number caveat above.) |
