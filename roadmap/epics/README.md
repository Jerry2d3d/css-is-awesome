...
| [v1.2](./v1-2/README.md) | **Coverage** — RTL audit, form validation, i18n, print, MUI/Chakra migration, analyzer health report, token intelligence, print theme tokens | v1-2/ | 53 | **7 of 8 epics complete** (2026-09-09/10): RTL audit, form validation, i18n recipes, analyzer health report, token intelligence, print theme tokens, and print-recipe-superseded-into-v1.0. Only MUI/Chakra migration remains unstarted. |
