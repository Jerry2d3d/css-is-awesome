...
>
> **6. It duplicates a package that already exists and is better.** A consumer's own React component library already publishes a large, mature catalogue against cia — including equivalents of two of this epic's four named targets, each shipping with tests, stories and a README. The generated versions crash. boiler-project-ai is cia's designated showcase consumer; shipping a thinner, generated rival from cia's own repo would compete with the showcase and split the React story in two.
>
