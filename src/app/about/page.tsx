    ...
    <>
      ...
      <article className={styles.body}>
        ...
        <ol className={styles.timeline}>
          ...
          <TimelineItem date="next — what's coming" title="MCP, CLI, agent bots.">A companion CLI for scaffolding, an MCP server so agents can reason about the system directly, and custom bots in ChatGPT, Claude, and Gemini that speak it fluently.</TimelineItem>
        </ol>
