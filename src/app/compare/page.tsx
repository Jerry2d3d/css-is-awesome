...
const ROWS: Row[] = [
  ...
  { feature: "Theme files shipped",cia: "8 families (one file each, light+dark inside)", tailwind: "0 (config only)", bootstrap: "2 (light / dark)", note: "Seven families carry both modes in a single file via light-dark(). Terminal is the exception — shipped as two single-mode files (terminal dark-only, terminal-light light-only), because they're two brands rather than two modes. 9 sources, 21 built files." },
