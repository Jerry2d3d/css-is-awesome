...
const ROWS: Row[] = [
  ...
  { feature: "Typed theme contract + validator", cia: "127 required + 36 optional · CI gate",      tailwind: "untyped config",      bootstrap: false, note: "scripts/theme-validator.js fails the build if any theme misses a contract token or a contrast pair. check:theme-drift separately proves the committed CSS still matches its SCSS source. No equivalent in Tailwind or Bootstrap." },
